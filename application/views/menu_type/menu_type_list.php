        ...
        <form id="myform" method="post" onsubmit="return false">
           ...
           <div class="row" style="margin-bottom: 10px">
            <div class="col-xs-12 col-md-4">
                <?php echo anchor(site_url('menu_type/create'), '<i class="fa fa-plus"></i> Create', 'class="btn bg-purple"'); ?>
            </div>
            ...
            <div class="col-xs-12 col-md-4 text-right">
                <?php echo anchor(site_url('menu_type/printdoc'), '<i class="fas fa-print"></i> Print', 'class="btn bg-maroon"'); ?>
