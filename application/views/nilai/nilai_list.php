...
<div class="col-xs-12">
    <div class="box">
      ...
      <div class="box-body">
		...
		<td  style="width: 10px;padding-left: 8px;"><input type="checkbox" name="id" value="<?= $nilai->;?>" />&nbsp;</td>
			...
			<td style="text-align:center" width="200px">
				<?php 
				echo anchor(site_url('nilai/read/'.$nilai->),'<i class="fa fa-search"></i>', 'class="btn btn-xs btn-primary"  data-toggle="tooltip" title="Detail"'); 
				echo ' '; 
				echo anchor(site_url('nilai/update/'.$nilai->),' <i class="fa fa-edit"></i>', 'class="btn btn-xs btn-warning" data-toggle="tooltip" title="Edit"'); 
				echo ' '; 
				echo anchor(site_url('nilai/delete/'.$nilai->),' <i class="fa fa-trash"></i>','class="btn btn-xs btn-danger" onclick="javasciprt: return confirmdelete(\'nilai/delete/'.$nilai->.'\')"  data-toggle="tooltip" title="Delete" '); 
				?>
			</td>
		</tr>
                <?php
