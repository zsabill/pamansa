        ...
        <div class="box">
            ...
            <div class="box-body">
                ...
                <div class="form-group">
                    ...
                    <input type="hidden" class="form-control" name="supload_kk" value="<?php echo $upload_kk; ?>" />
                </div>
                <div class="form-group">
                    ...
                    <input type="hidden" class="form-control" name="supload_aktekelahiran" value="<?php echo $upload_aktekelahiran; ?>" />
                </div>
                <div class="form-group">
                    ...
                    <input type="hidden" class="form-control" name="supload_skl" value="<?php echo $upload_skl; ?>" />
                </div>
                <div class="form-group">
                    ...
                    <input type="hidden" class="form-control" name="sbukti_pembayaran" value="<?php echo $bukti_pembayaran; ?>" />
                </div>
